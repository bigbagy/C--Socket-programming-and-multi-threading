...
```
git clone https://github.gatech.edu/gios-fall-2017/gios-fall2017-pr1.git 
```
...
This file can be either a markdown file (student-readme.md) or a PDF (student-readme.pdf).
